...
public  :
    ...
    static inline const char *type( Object *o ){
        switch(o->xtype){
	...
	static inline Object *fromxml( xmlNode *node ){
	...
	static inline Object *fromxml( char *xml ){
		xmlDoc  *doc  = NULL;
    	xmlNode *root = NULL;
	...
	static inline unsigned int assert_type( Object *a, Object *b, unsigned int ntypes, ... ){
    ...
    static inline void replace( string &source, const string find, string replace ) {
        size_t j;
    ...
    static inline void parse_string( string& s ){
        /* newline */
        replace( s, "\\n", "\n" );
        /* carriage return */
        replace( s, "\\r", "\r" );
    ...
    inline unsigned char *serialize(){
    ...
    inline void print( unsigned int tabs = 0 ){
		unsigned int i;
    ...
    inline void println( unsigned int tabs = 0 ){
        print(tabs);
        printf("\n");
    }

	inline string toxml( unsigned int tabs = 0 ){
		unsigned int i;
		string       xtabs;
		stringstream xml;
	...
	inline Object * dotequal( Object *o ){
        stringstream ret;
	...
	inline Object *map( Object *map, Object *o ){
	...
	inline Object *remove( Object *index ){
		if( xtype != H_OT_ARRAY ){
	...
	inline Object *unmap( Object *map ){
		if( xtype != H_OT_MAP ){
	...
	inline Object *at( char *map ){
		Object tmp(map);
		return xarray[mapFind(&tmp)];
	}

    inline Object& at( Object *index, Object *set ){
		if( xtype == H_OT_STRING ){
