...
HYBRIS_EXPORTED_FUNCTIONS() {
	{ "gc_collect",	 		  hgc_collect, 		  	 H_NO_ARGS },
    { "gc_mm_items", 		  hgc_mm_items, 		 H_NO_ARGS },
    { "gc_mm_usage", 		  hgc_mm_usage, 		 H_NO_ARGS },
    { "gc_collect_threshold", hgc_collect_threshold, H_NO_ARGS },
    { "", NULL }
};
